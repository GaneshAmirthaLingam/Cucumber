Feature: validate the adactin hotel booking page
  ...
  Scenario Outline: 
    ...
    And user as Select "<Check Out Date>"
    Then user to Select "<Adults per Room>"
    ...
    Examples: 
      ...
      | GaneshA10 | Naturejo@88 | Berlin   | Hotel Hilton | Double    | 3 - Three       | 04/10/2022    | 23/10/2022     | 3 - Three       | 3 - Three         | Ganesh     | A         | No 27, 2nd Cross Street, Dharmapuri, Puducherry | 3752 4325 5698 8745 | Maestro          | 04/09             | 04/2073          |        973 |
